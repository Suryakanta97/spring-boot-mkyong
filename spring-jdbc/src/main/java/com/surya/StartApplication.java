...
import com.surya.customer.Customer;
import com.surya.customer.CustomerRepository;
import com.surya.repository.BookRepository;
import com.surya.sp.StoredFunction;
import com.surya.sp.StoredProcedure1;
import com.surya.sp.StoredProcedure2;
import com.surya.sp.TestData;
import com.surya.util.NameGenerator;
...
public class StartApplication implements CommandLineRunner {
    ...
    void startBookApp() {
        ...
        List<Book> books = Arrays.asList(
                ...
                new Book("surya in Java", new BigDecimal("1.99")),
